...
public class VenueTemplateTest extends AbstractFoursquareApiTest {
    ...
    public void getVenue() {
        ...
        assertEquals("https://irs2.4sqi.net/img/general/612x612/690170_HnduV5yM9RLNUHQseOOvDi3OCm4AoYmMld79iVTxrPg.jpg", venue.getPhotos().getGroups().get(0).getItems().get(0).getUrl());
        mockServer.verify();
    }
